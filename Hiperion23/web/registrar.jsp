            ...
            <div class="modal">
                <div class="formu">
                    ...
                    <form action="RegistrarUsuario" method="post">
                        ...
                        <input title="Se necesita un nombre" type="text" name="nom" id="nom"size="15" placeholder="Misael" pattern="^[A-ZÁÉÍÓÚÑ]+[a-záéíóúñ]+$" ondrop="return false"  onpaste="return false" oncut="return false" maxlength="20" required/>
                        <br>
